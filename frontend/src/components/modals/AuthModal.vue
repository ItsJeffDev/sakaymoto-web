  ...
  <div class="modal-overlay" :class="{ open: modal.isOpen }" @click.self="modal.close()">
    <div class="modal-box" role="dialog" aria-modal="true" aria-labelledby="auth-title">
      <aside class="auth-aside">
        <button class="modal-close aside-close" aria-label="Close" @click="modal.close()">
          <X :size="17" />
        </button>
        ...
        <ul class="aside-list">
          <li>
            <span><Check :size="14" /></span>Verified motorcycles
          </li>
          <li>
            <span><Check :size="14" /></span>Flexible daily rentals
          </li>
          <li>
            <span><Check :size="14" /></span>Support when you need it
          </li>
        </ul>
        <div class="aside-footer">
          <strong>4.9/5</strong><span>from riders across the Philippines</span>
        </div>
      </aside>

      <section class="auth-content">
        <button class="modal-close content-close" aria-label="Close" @click="modal.close()">
          <X :size="16" />
        </button>
          ...
          <form @submit.prevent="handleLogin">
            ...
            <div class="field">
              ...
              <div class="input-wrap">
                ...
                >
                  <EyeOff v-if="showLoginPassword" :size="17" /><Eye v-else :size="17" />
                </button>
              </div>
            </div>
            <div class="form-options">
              <label class="check-label"><input type="checkbox" /> <span>Remember me</span></label
              ><a href="#">Forgot password?</a>
            </div>
            <button class="btn btn-primary btn-block" type="submit" :disabled="isSubmitting">
              {{ isSubmitting ? 'Logging in...' : 'Log In' }} <ArrowRight :size="17" />
            </button>
          </form>
          <p class="modal-note">
          ...
          <form @submit.prevent="handleRegister">
            ...
            <div class="field">
              ...
              <div class="input-wrap">
                ...
                >
                  <EyeOff v-if="showRegisterPassword" :size="17" /><Eye v-else :size="17" />
                </button>
              </div>
            </div>
            <p class="terms">
...
.modal-box {
  ...
  box-shadow: 0 28px 80px -28px rgba(8, 27, 54, 0.46);
  display: grid;
...
.form-panel {
  max-width: 400px;
  animation: form-in 0.25s ease both;
}
.form-kicker {
  margin-bottom: 8px;
}
