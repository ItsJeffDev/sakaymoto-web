  ...
  <header :class="{ scrolled: isScrolled }">
    <div class="container nav">
      ...
      <div class="nav-actions">
        ...
        <a href="#" class="btn btn-primary btn-sm" @click.prevent="modal.open('register')">Get Started</a>
...
.brand { display: flex; align-items: center; gap: 10px; font-family: var(--ff-display); font-weight: 800; font-size: 1.3rem; color: var(--navy); }
header:not(.scrolled) .brand { color: #fff; }
.brand .dot { color: var(--orange); }

.nav-links { display: flex; align-items: center; gap: 36px; }
.nav-links a { font-family: var(--ff-display); font-weight: 500; font-size: 0.93rem; color: var(--navy); opacity: 0.85; transition: opacity .2s; }
header:not(.scrolled) .nav-links a { color: #fff; }
.nav-links a:hover { opacity: 1; }

.nav-actions { display: flex; align-items: center; gap: 12px; }
.nav-actions .link-btn { font-family: var(--ff-display); font-weight: 600; font-size: 0.9rem; color: var(--navy); padding: 10px 6px; }
header:not(.scrolled) .nav-actions .link-btn { color: #fff; }
